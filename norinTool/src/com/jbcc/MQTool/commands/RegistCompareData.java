...
/**
 * 比較除外項目データを登録する.
 * IDが重複する場合はupdate IDが存在しない場合はinsertになる
 * 
 */
public class RegistCompareData extends ToolCommand {

	@Override
	public void execute(String[] args) throws Exception {

		// insert update なので merge文
		String sql = RESOURCE.getSql("ResistCompareData1");
	...
	private String insertQuery(Map<String, String> args) {
		...
		cols.append(" ,(select nvl((select Max(id) from noncompare_m),0) from dual) + 1)");
